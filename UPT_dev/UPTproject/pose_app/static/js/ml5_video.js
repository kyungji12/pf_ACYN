...
var countDown = setInterval(function(){
    ...
    var stopSection = document.getElementById("stopSection");
    timeLeft -=1 ;
    if (timeLeft <= 0) {
    ...
    } else if (0 < timeLeft && timeLeft <= 10) {
        readySection.style.display = "none";
        workoutSection.style.display = "block";
        workoutSection.innerHTML = "<h1 class='title'>OK!</h1><p class='desc'><span class='timer'>"+timeLeft+"</span>초 버티세요! </p>";
    } else {
        readySection.innerHTML = "<h1 class='title'>자세를 <br>맞춰주세요.</h1><p class='desc'><span class='timer'>"+(timeLeft-10)+"</span>초 후 자세를 취해주세요. </p>";
    }
},1000);
